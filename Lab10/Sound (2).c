// Sound.c
// Super duper ultra pre-alpha wooo
// Might even work!
...
const uint8_t sound2Inst[] = {0,2,0,2,0,2,0};
...
int noteConvert(int note){
	int freq = (pow(2, ((note + 105) / 12)) * 1.67);
	return (1000000000 / (12.5 * freq * 32)); //1 billion ns/s, 12.5 ns/cycle, 32 DAQ outputs per complete wave
}
...
void sound2Set(){
	...
	sound2curr = 0;
	sound2count = sound1Times[sound1arrpt];
	sound2pt = 0;
	TIMER2_CTL_R = 0x00000000;
	TIMER2_TAILR_R = noteConvert(sound1Notes[sound1arrpt]);
